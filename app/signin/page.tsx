    ...
    >
      ...
      >
            ...
            >
              {[['1,247', 'members'], ['14', 'cities'], ['142', 'events / year']].map(([n, l]) => (
                <div key={l}>
                  ...
                  <div className="ee-mono" style={{ color: 'rgba(255,255,255,0.6)', marginTop: 4 }}>
                    {l.toUpperCase()}
                  </div>
                </div>
              ))}
        ...
        >
              ...
              <div>
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                  ...
                  <Link
                    href="#"
                    className="ee-mono"
                    style={{ color: 'var(--ee-ink-3)', fontSize: 10 }}
                  >
                    Forgot?
                  </Link>
                </div>
          ...
          >
            <Link href="/apply" className="ee-mono" style={{ color: 'var(--ee-ink-2)' }}>
              ← Apply instead
            </Link>
